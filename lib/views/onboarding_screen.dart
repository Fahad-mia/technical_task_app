  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        exit(0); // This works for Android; iOS apps generally don't allow force-close
        return false;
      },
      child: Scaffold(
            ...
            child: Column(
              children: [
                ...
                Obx(() => CustomTextContainer(
                  headText: controller.currentIndex.value != controller.images.length - 1
                      ? AppText.textOnBoardBold
                      : AppText.textOnBoardBold2,
                  titleText: controller.currentIndex.value != controller.images.length - 1
                ...
                Obx(() {
                  return Row(
                    ...
                    children: controller.images.asMap().entries.map((item) {
                      return Container(
                        height: 12,
                        width: 12,
                ...
                Obx(() {
                  return CustomButton(
                    label: controller.currentIndex.value != controller.images.length - 1
                        ? "Next"
                        : "Get Started",
                    width: screenSize.width * 0.88,
                    borderRadius: 100,
                    onPressed: controller.currentIndex.value != controller.images.length - 1
                        ? controller.nextPage
